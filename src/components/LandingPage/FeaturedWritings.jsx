      ...
      <div style={{ flexDirection: "column" }} className="container">
        ...
        <div className="display-flex featured featured-writing">
          <div className="display-flex featured__content">
            ...
            <small>Co-written for SEBA Bank.</small>
            <p className="featured__content-body">A data analysis based piece that evaluates the performance of different DeFi portfolios. Testing 3 different approaches: hold ETH as a general proxy for DeFi, buy/sell DeFi governance tokens, and earning governance tokens through yield farming.</p>
          </div>
          <div className="display-flex" style={{ rowGap: "1vw", fontSize: "2.5vw", paddingRight: "30px", flexDirection: "column", alignItems: "flex-end", justifyContent: "center", flex: 1, width: "100%", height: "100%" }}>
        ...
        <div className="display-flex featured featured-writing">
          <div className="display-flex featured__content">
            ...
            <small>Written for my own blog.</small>
            <p className="featured__content-body">A framework-driven analysis examining the presented three pillars of a crypto wallet and its widening usage spectrum. Ultimately proposing a practical method in quantifying a crypto wallet’s "elasticity". This piece was motivated during my time working at a crypto wallet startup in Shanghai.</p>
          </div>
          <div className="display-flex" style={{ rowGap: "1vw", fontSize: "2.5vw", paddingRight: "30px", flexDirection: "column", alignItems: "flex-end", justifyContent: "center", flex: 1, width: "100%", height: "100%" }}>
            <a className="display-flex featured__link" href="https://paragraph.com/@ecbsj/examining-the-three-pillars-of-a-crypto-wallet-and-its-widening-usage-spectrum" target="_blank">
              Read
              <MdOpenInNew className="featured__content-title-icon" />{" "}
            </a>
          </div>
